...
RUN CFLAGS="-DDYNAMIC_MODULE_LIMIT=4"; export CFLAGS \
&& ./configure --prefix=/usr/local/apache2 --enable-speling=static --enable-deflate=static --enable-ssl=static --enable-expires=static --enable-headers=static --enable-rewrite=static --with-included-apr --with-mpm=event --enable-suexec=static --with-suexec-docroot=/var/www --enable-nonportable-atomics=yes --with-pcre=static --enable-authz-core=static --enable-cache=static --enable-cache-disk=static --enable-cgid=static --enable-http2=static --enable-mime-magic=static --enable-vhost-alias=static --enable-unique-id=static --enable-unixd=static --enable-dir=static --enable-log-sql=shared --enable-log-sql-mysql=shared --enable-log-sql-ssl=shared --enable-filter=static --enable-mime=static --enable-actions=static --enable-alias=static --enable-proxy=static --enable-proxy-fcgi=static --enable-slotmem-shm=static --enable-socache-shmcb=static --enable-status=static --enable-authz-host=static --enable-setenvif=static --enable-log-config=static \
&& make \
&& make install 
